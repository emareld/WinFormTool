...
namespace WinFormTool
{
    ...
    class ToolChineseDateTime
    {
        ...
        public ToolChineseDateTime(int year, int month, int day, bool isLeap = false)
            : this(year, month, day, 0, 0, 0, isLeap)
        {

        }

        public ToolChineseDateTime(int year, int month, int day, int hour, int minute, int second, bool isLeap = false)
        ...
        public static ToolChineseDateTime Now => new ToolChineseDateTime(DateTime.Now);
        ...
        /// <summary>
        /// 获取当前日期（公历）yyyy-MM-dd
        /// </summary>
        /// <param name="fh">间隔符</param>
        /// <returns></returns>
        public string ToShortDateTime(string fh = "-")
        {
            return string.Format("{0}{3}{1}{3}{2}", DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, fh);
        }
        /// <summary>
        /// 短日期（农历）
        /// </summary>
